...
class SimpleMapTest {
    ...
    void whenCheckPutNull() {
        assertThat(map.put(0, "0")).isTrue();
        assertThat(map.put(null, "0")).isFalse();
        assertThat(map).hasSize(5);
        assertThat(map.put(25, "8")).isFalse();
        assertThat(map).hasSize(5);
        assertThat(map.put(10, "10")).isFalse();
    ...
    @Test
    void whenCheckIteratorConcurrentModEx() {
        Iterator<Integer> it = map.iterator();
        map.put(0, "0");
        map.remove(0);
